...
```json
{
  ...
  "pagination": {
    ...
    "total": 100,
    "lastPage": 10,
    "firstPageUrl": "http://192.168.10.141:8080/api/v1/resource?page=1&per_page=10",
    "lastPageUrl": "http://192.168.10.141:8080/api/v1/resource?page=10&per_page=10",
    "nextPageUrl": "http://192.168.10.141:8080/api/v1/resource?page=2&per_page=10",
    "prevPageUrl": null
  }
}
```
...
```json
{
  ...
  "data": {
    ...
    "email": "john@example.com",
    "role": "USER",
    "profileImage": "http://192.168.10.141:9000/users/uuid/profile.jpg",
    "createdAt": "2024-01-30T10:00:00Z"
  }
}
```
...
```json
{
  ...
  "pagination": {
    ...
    "total": 50,
    "lastPage": 5,
    "firstPageUrl": "http://192.168.10.141:8080/api/v1/users?page=1&per_page=10",
    "lastPageUrl": "http://192.168.10.141:8080/api/v1/users?page=5&per_page=10",
    "nextPageUrl": "http://192.168.10.141:8080/api/v1/users?page=2&per_page=10",
    "prevPageUrl": null
  }
}
```
...
```json
{
  ...
  "data": {
    "imageUrl": "http://192.168.10.141:9000/users/uuid/profile.jpg"
  }
}
```
...
```json
{
  ...
  "pagination": {
    ...
    "total": 25,
    "lastPage": 3,
    "firstPageUrl": "http://192.168.10.141:8080/api/v1/employees?page=1&per_page=10",
    "lastPageUrl": "http://192.168.10.141:8080/api/v1/employees?page=3&per_page=10",
    "nextPageUrl": "http://192.168.10.141:8080/api/v1/employees?page=2&per_page=10",
    "prevPageUrl": null
  }
}
```
...
```json
{
  ...
  "pagination": {
    ...
    "total": 5,
    "lastPage": 1,
    "firstPageUrl": "http://192.168.10.141:8080/api/v1/schedules?page=1&per_page=10",
    "lastPageUrl": "http://192.168.10.141:8080/api/v1/schedules?page=1&per_page=10",
    "nextPageUrl": null,
    "prevPageUrl": null
  }
}
...
```json
{
  ...
  "pagination": {
    ...
    "total": 20,
    "lastPage": 2,
    "firstPageUrl": "http://192.168.10.141:8080/api/v1/attendance/history?page=1&per_page=10",
    "lastPageUrl": "http://192.168.10.141:8080/api/v1/attendance/history?page=2&per_page=10",
    "nextPageUrl": "http://192.168.10.141:8080/api/v1/attendance/history?page=2&per_page=10",
    "prevPageUrl": null
  }
}
```
...
```json
{
  ...
  "pagination": {
    ...
    "total": 100,
    "lastPage": 10,
    "firstPageUrl": "http://192.168.10.141:8080/api/v1/attendance/all?page=1&per_page=10",
    "lastPageUrl": "http://192.168.10.141:8080/api/v1/attendance/all?page=10&per_page=10",
    "nextPageUrl": "http://192.168.10.141:8080/api/v1/attendance/all?page=2&per_page=10",
    "prevPageUrl": null
  }
}
```
...
```json
{
  ...
  "pagination": {
    ...
    "total": 30,
    "lastPage": 2,
    "firstPageUrl": "http://192.168.10.141:8080/api/v1/payrolls?page=1&per_page=15",
    "lastPageUrl": "http://192.168.10.141:8080/api/v1/payrolls?page=2&per_page=15",
    "nextPageUrl": "http://192.168.10.141:8080/api/v1/payrolls?page=2&per_page=15",
    "prevPageUrl": null
  }
}
```
